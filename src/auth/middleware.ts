 ...
 */
export function bearerTokenAuth(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
 ...
 */
export function requestLogging(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
